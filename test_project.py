...
class TestHabits:
    ...
    def test_db_logic(self):
        ...
        received_object = get_habit_by_name(self.db, "first habit")
        ...
        add_habit(self.db, another_test_habit)
        received_object = get_habit_by_name(self.db, "another test habit")
        ...
        all_habits = get_all_habits(self.db)
        ...
        update_habit_streaks(self.db, another_test_habit.name)
        another_test_habit = get_habit_by_name(self.db, another_test_habit.name)
        ...
        remove_habit(self.db, another_test_habit.name)
        removed_habit = get_habit_by_name(self.db, another_test_habit.name)
    ...
    def test_analysis(self):
        ...
        output = analyse_habits(self.db, choice)
        ...
        output = analyse_habits(self.db, choice, period=2)
